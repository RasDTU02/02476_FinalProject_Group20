...
* [x] Create the initial file structure using cookiecutter with an appropriate template (M6) RASMUS
...
* [x] Remember to comply with good coding practices (`pep8`) while doing the project (M7) BJØRN
